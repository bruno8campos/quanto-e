  ...
  return (
    <div className="items-center gap-[2%] md:flex md:flex-wrap">
      ...
      <div className=" mt-5 flex items-center justify-center p-5 md:w-[32%]">
        <button className="rounded-xl bg-primary-100 px-4 py-2 text-gray-50 transition duration-100 hover:cursor-pointer hover:bg-lime-200 hover:text-primary-300 active:bg-gray-300">
          Calcular Orçamento
        </button>
      </div>
      {/* Orçamento Final */}
